...
// VulkanProvider::Create): this vector's size and order always matches what
// VulkanProvider::Create itself enumerates, even for entries flagged as
// duplicates. Independent of whether a VulkanProvider has been created yet,
// for building a device-selection dropdown before graphics
